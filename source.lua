...
if game.CoreGui:FindFirstChild('YetahubUiLib') then
    game.CoreGui:FindFirstChild('YetahubUiLib'):Destroy()
    destroyed = true
end
...
local YetahubUiLib = Instance.new("ScreenGui")

YetahubUiLib.Name = "YetahubUiLib"

protect_gui(YetahubUiLib)
...
function library:Destroy()
    YetahubUiLib:Destroy()
    if keybindConnection then
        keybindConnection:Disconnect()
    end
end
function library:Hide()
   YetahubUiLib.Enabled = not YetahubUiLib.Enabled
end	
